...
// Query: *[_type == "settings"][0] {    logo {  ...,  asset->},    welcomeText,    backgroundVideo {   "url": asset->url},    mobileMenuBackgroundVideo {   "url": asset->url},    siteTitle,    seoDescription,    ogImage {  ...,  asset->}  }
...
// Query: *[_type == "contact" && _id == "contact"][0] {    _id,    seoTitle,    seoDescription,    ogImage {  ...,  asset->},    contactBuilder []{  _type,  _key,  _type == "video" => {    "url": vimeoUrl,    title,    "backgroundVideo": ^.backgroundVideo {   "url": asset->url}  },  _type == "projectHero" => {    backgroundColor,    title,    subtitle,    about,    infoSectionTitle,    infoSection {      title,      items[]{ title, text }    }  },  _type == "gallery" => {    backgroundColor,    items[]{      _key,      type,      "imageUrl": select(type == "photo" => image.asset->url),      "photoAltText": select(type == "photo" => photoAltText),      "thumbnailUrl": select(type == "video" => thumbnail.asset->url),      "videoAltText": select(type == "video" => videoAltText),      "vimeoUrl": select(type == "video" => vimeoUrl)    }  },  _type == "textWithBackgroundColor" => {    backgroundColor,    about []{  ...,  markDefs[]{    ...,    _type == "link" => {      ...,      linkType == "documentaries" => {        "slug": documentaries->slug.current      }    }  }}  },  _type == "photoInfoGallery" => {    backgroundColor,    title,    items[]{      _key,      name,      role,      location,      "url": url{linkType, href, email, openInNewTab},      image {  ...,  asset->}    }  },  _type == "contactBlock" => {    backgroundType,    backgroundVideo {   "url": asset->url},    backgroundColor,    centerText,    hoverCenterText,    firstColumn []{  ...,  markDefs[]{    ...,    _type == "link" => {      ...,      linkType == "documentaries" => {        "slug": documentaries->slug.current      }    }  }},    secondColumn []{  ...,  markDefs[]{    ...,    _type == "link" => {      ...,      linkType == "documentaries" => {        "slug": documentaries->slug.current      }    }  }},    thirdColumn []{  ...,  markDefs[]{    ...,    _type == "link" => {      ...,      linkType == "documentaries" => {        "slug": documentaries->slug.current      }    }  }}  },  _type == "logoSection" => {    backgroundColor,    title,    items[]{      _key,      altText,      image {  ...,  asset->}    }  }}  }
...
// Source: sanity/lib/queries.ts
// Variable: contactColumnsQuery
// Query: *[_type == "contact" && _id == "contact"][0] {    "contactBlock": contactBuilder[_type == "contactBlock"][0] {      firstColumn []{  ...,  markDefs[]{    ...,    _type == "link" => {      ...,      linkType == "documentaries" => {        "slug": documentaries->slug.current      }    }  }},      secondColumn []{  ...,  markDefs[]{    ...,    _type == "link" => {      ...,      linkType == "documentaries" => {        "slug": documentaries->slug.current      }    }  }},      thirdColumn []{  ...,  markDefs[]{    ...,    _type == "link" => {      ...,      linkType == "documentaries" => {        "slug": documentaries->slug.current      }    }  }}    }  }
export type ContactColumnsQueryResult = {
  contactBlock: {
    firstColumn: Array<
      | {
          children?: Array<{
...
// Query: *[_type == "documentaries" && slug.current == $slug][0] {    _id,    name,    "slug": slug.current,    seoTitle,    seoDescription,    ogImage {  ...,  asset->},    client,    backgroundVideo {   "url": asset->url},    documentariesBuilder []{  _type,  _key,  _type == "video" => {    "url": vimeoUrl,    title,    "backgroundVideo": ^.backgroundVideo {   "url": asset->url}  },  _type == "projectHero" => {    backgroundColor,    title,    subtitle,    about,    infoSectionTitle,    infoSection {      title,      items[]{ title, text }    }  },  _type == "gallery" => {    backgroundColor,    items[]{      _key,      type,      "imageUrl": select(type == "photo" => image.asset->url),      "photoAltText": select(type == "photo" => photoAltText),      "thumbnailUrl": select(type == "video" => thumbnail.asset->url),      "videoAltText": select(type == "video" => videoAltText),      "vimeoUrl": select(type == "video" => vimeoUrl)    }  },  _type == "textWithBackgroundColor" => {    backgroundColor,    about []{  ...,  markDefs[]{    ...,    _type == "link" => {      ...,      linkType == "documentaries" => {        "slug": documentaries->slug.current      }    }  }}  },  _type == "photoInfoGallery" => {    backgroundColor,    title,    items[]{      _key,      name,      role,      location,      "url": url{linkType, href, email, openInNewTab},      image {  ...,  asset->}    }  },  _type == "contactBlock" => {    backgroundType,    backgroundVideo {   "url": asset->url},    backgroundColor,    centerText,    hoverCenterText,    firstColumn []{  ...,  markDefs[]{    ...,    _type == "link" => {      ...,      linkType == "documentaries" => {        "slug": documentaries->slug.current      }    }  }},    secondColumn []{  ...,  markDefs[]{    ...,    _type == "link" => {      ...,      linkType == "documentaries" => {        "slug": documentaries->slug.current      }    }  }},    thirdColumn []{  ...,  markDefs[]{    ...,    _type == "link" => {      ...,      linkType == "documentaries" => {        "slug": documentaries->slug.current      }    }  }}  },  _type == "logoSection" => {    backgroundColor,    title,    items[]{      _key,      altText,      image {  ...,  asset->}    }  }}  }
...
// Query: *[_type == "campaign" && slug.current == $slug][0] {    _id,    name,    "slug": slug.current,    seoTitle,    seoDescription,    ogImage {  ...,  asset->},    backgroundVideo {   "url": asset->url},    campaignBuilder []{  _type,  _key,  _type == "video" => {    "url": vimeoUrl,    title,    "backgroundVideo": ^.backgroundVideo {   "url": asset->url}  },  _type == "projectHero" => {    backgroundColor,    title,    subtitle,    about,    infoSectionTitle,    infoSection {      title,      items[]{ title, text }    }  },  _type == "gallery" => {    backgroundColor,    items[]{      _key,      type,      "imageUrl": select(type == "photo" => image.asset->url),      "photoAltText": select(type == "photo" => photoAltText),      "thumbnailUrl": select(type == "video" => thumbnail.asset->url),      "videoAltText": select(type == "video" => videoAltText),      "vimeoUrl": select(type == "video" => vimeoUrl)    }  },  _type == "textWithBackgroundColor" => {    backgroundColor,    about []{  ...,  markDefs[]{    ...,    _type == "link" => {      ...,      linkType == "documentaries" => {        "slug": documentaries->slug.current      }    }  }}  },  _type == "photoInfoGallery" => {    backgroundColor,    title,    items[]{      _key,      name,      role,      location,      "url": url{linkType, href, email, openInNewTab},      image {  ...,  asset->}    }  },  _type == "contactBlock" => {    backgroundType,    backgroundVideo {   "url": asset->url},    backgroundColor,    centerText,    hoverCenterText,    firstColumn []{  ...,  markDefs[]{    ...,    _type == "link" => {      ...,      linkType == "documentaries" => {        "slug": documentaries->slug.current      }    }  }},    secondColumn []{  ...,  markDefs[]{    ...,    _type == "link" => {      ...,      linkType == "documentaries" => {        "slug": documentaries->slug.current      }    }  }},    thirdColumn []{  ...,  markDefs[]{    ...,    _type == "link" => {      ...,      linkType == "documentaries" => {        "slug": documentaries->slug.current      }    }  }}  },  _type == "logoSection" => {    backgroundColor,    title,    items[]{      _key,      altText,      image {  ...,  asset->}    }  }}  }
...
// Query: *[_type == "animation" && slug.current == $slug][0] {    _id,    name,    "slug": slug.current,    seoTitle,    seoDescription,    ogImage {  ...,  asset->},    client,    backgroundVideo {   "url": asset->url},    animationBuilder []{  _type,  _key,  _type == "video" => {    "url": vimeoUrl,    title,    "backgroundVideo": ^.backgroundVideo {   "url": asset->url}  },  _type == "projectHero" => {    backgroundColor,    title,    subtitle,    about,    infoSectionTitle,    infoSection {      title,      items[]{ title, text }    }  },  _type == "gallery" => {    backgroundColor,    items[]{      _key,      type,      "imageUrl": select(type == "photo" => image.asset->url),      "photoAltText": select(type == "photo" => photoAltText),      "thumbnailUrl": select(type == "video" => thumbnail.asset->url),      "videoAltText": select(type == "video" => videoAltText),      "vimeoUrl": select(type == "video" => vimeoUrl)    }  },  _type == "textWithBackgroundColor" => {    backgroundColor,    about []{  ...,  markDefs[]{    ...,    _type == "link" => {      ...,      linkType == "documentaries" => {        "slug": documentaries->slug.current      }    }  }}  },  _type == "photoInfoGallery" => {    backgroundColor,    title,    items[]{      _key,      name,      role,      location,      "url": url{linkType, href, email, openInNewTab},      image {  ...,  asset->}    }  },  _type == "contactBlock" => {    backgroundType,    backgroundVideo {   "url": asset->url},    backgroundColor,    centerText,    hoverCenterText,    firstColumn []{  ...,  markDefs[]{    ...,    _type == "link" => {      ...,      linkType == "documentaries" => {        "slug": documentaries->slug.current      }    }  }},    secondColumn []{  ...,  markDefs[]{    ...,    _type == "link" => {      ...,      linkType == "documentaries" => {        "slug": documentaries->slug.current      }    }  }},    thirdColumn []{  ...,  markDefs[]{    ...,    _type == "link" => {      ...,      linkType == "documentaries" => {        "slug": documentaries->slug.current      }    }  }}  },  _type == "logoSection" => {    backgroundColor,    title,    items[]{      _key,      altText,      image {  ...,  asset->}    }  }}  }
...
// Query: *[_type == "aboutPage"][0] {    _id,    seoTitle,    seoDescription,    ogImage {  ...,  asset->},    aboutBuilder []{  _type,  _key,  _type == "video" => {    "url": vimeoUrl,    title,    "backgroundVideo": ^.backgroundVideo {   "url": asset->url}  },  _type == "projectHero" => {    backgroundColor,    title,    subtitle,    about,    infoSectionTitle,    infoSection {      title,      items[]{ title, text }    }  },  _type == "gallery" => {    backgroundColor,    items[]{      _key,      type,      "imageUrl": select(type == "photo" => image.asset->url),      "photoAltText": select(type == "photo" => photoAltText),      "thumbnailUrl": select(type == "video" => thumbnail.asset->url),      "videoAltText": select(type == "video" => videoAltText),      "vimeoUrl": select(type == "video" => vimeoUrl)    }  },  _type == "textWithBackgroundColor" => {    backgroundColor,    about []{  ...,  markDefs[]{    ...,    _type == "link" => {      ...,      linkType == "documentaries" => {        "slug": documentaries->slug.current      }    }  }}  },  _type == "photoInfoGallery" => {    backgroundColor,    title,    items[]{      _key,      name,      role,      location,      "url": url{linkType, href, email, openInNewTab},      image {  ...,  asset->}    }  },  _type == "contactBlock" => {    backgroundType,    backgroundVideo {   "url": asset->url},    backgroundColor,    centerText,    hoverCenterText,    firstColumn []{  ...,  markDefs[]{    ...,    _type == "link" => {      ...,      linkType == "documentaries" => {        "slug": documentaries->slug.current      }    }  }},    secondColumn []{  ...,  markDefs[]{    ...,    _type == "link" => {      ...,      linkType == "documentaries" => {        "slug": documentaries->slug.current      }    }  }},    thirdColumn []{  ...,  markDefs[]{    ...,    _type == "link" => {      ...,      linkType == "documentaries" => {        "slug": documentaries->slug.current      }    }  }}  },  _type == "logoSection" => {    backgroundColor,    title,    items[]{      _key,      altText,      image {  ...,  asset->}    }  }}  }
